...
### Etapa 3 — Ajuste no endpoint de persistência e rename
...
**Arquivos Criados:**
- `src/scripts/utils/calcularMerge.ts` *(nome sugerido)* — motor de merge compartilhado entre os dois fluxos, sem dependências de Node (Etapa 4).
