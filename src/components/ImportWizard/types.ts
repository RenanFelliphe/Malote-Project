...
export interface EstadoImportacao {
   ...
   *
   * Etapa 14 (refatoracaoEmailFormatado.md): `conteudo` passou a guardar
   * HTML (produzido pelo `EmailEditorRico` em `EtapaDefinicao.tsx`), não
   * mais texto puro — mesmo formato já usado em `EmailConteudo.conteudo`
